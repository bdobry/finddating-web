			...
			<div class="fright">
				...
				<?php if ( get_previous_posts_link() ) : ?>
					...
					<p>
						...
						<?php echo get_previous_posts_link( '&larr; ' . __('Forrige post', 'lovecraft')); ?>
				...
				<?php if ( get_next_posts_link() ) : ?>
					...
					<p>
						...
						<?php echo get_next_posts_link( __('Nyere post', 'lovecraft') . ' &rarr;'); ?>
...
function lovecraft_modify_read_more_link() {
	return '<p><a class="more-link" href="' . get_permalink() . '">' . __('Læs mere','lovecraft') . '</a></p>';
}
