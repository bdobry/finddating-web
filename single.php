						...
						<div class="post-navigation-inner">
							...
							if (!empty( $prev_post )): ?>
								...
								<div class="post-nav-prev">
									<p><?php _e('Forrige', 'lovecraft'); ?></p>
									<h4>
										<a href="<?php echo get_permalink( $prev_post->ID ); ?>" title="<?php _e('Forrige post', 'lovecraft'); echo ': ' . esc_attr( get_the_title($prev_post) ); ?>">
							...
							if (!empty( $next_post )): ?>
								...
								<div class="post-nav-next">					
									<p><?php _e('Næste', 'lovecraft'); ?></p>
									<h4>
										<a title="<?php _e('Næste post', 'lovecraft'); echo ': ' . esc_attr( get_the_title($next_post) ); ?>" href="<?php echo get_permalink( $next_post->ID ); ?>">
